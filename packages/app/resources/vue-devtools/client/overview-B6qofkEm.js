import { _ as V, c as C, o as u, X as y, d as R, Y as I, C as k, Z as P, h as d, $ as v, a0 as S, b as e, a as H, l, u as o, a1 as D, t as g, e as N, q as i, x as n, a2 as M, F as x, M as r, a3 as _, a4 as E, a5 as j } from "./index-B-XIiefs.js";
const B = {}, U = {
  viewBox: "0 0 566 154",
  fill: "none",
...
const A = /* @__PURE__ */ V(B, [["render", O]]), F = "7.7.7", h = {
  "h-full": "",
  "w-full": "",
  flex: "",
  "of-auto": ""
  ...
  __name: "overview",
  setup(Z) {
    const { vueVersion: a } = I(), b = k(1), f = k(0);
    function w(s) {
      var m;
      let t = 0;
      for (const p of s)
        t++, (m = p.children) != null && m.length && (t += w(p.children));
      return t;
    }
    function T(s) {
      var t;
      b.value = ((t = s == null ? void 0 : s.routes) == null ? void 0 : t.length) || 1;
    }
    function L(s) {
      const t = E(s);
      t.inspectorId === "components" && (f.value = w(t.rootNodes));
    }
    return P(() => {
      d.value.getRouterInfo().then((s) => {
        var t;
        b.value = ((t = s == null ? void 0 : s.routes) == null ? void 0 : t.length) || 1;
      }), d.functions.on(v.ROUTER_INFO_UPDATED, T), d.value.getInspectorTree({ inspectorId: "components", filter: "" }).then((s) => {
        const t = E(s);
        f.value = w(t);
      });
    }), d.functions.on(v.INSPECTOR_TREE_UPDATED, L), S(() => {
      d.functions.off(v.INSPECTOR_TREE_UPDATED, L), d.functions.off(v.ROUTER_INFO_UPDATED, T);
    }), (s, t) => {
      const m = A, p = j("RouterLink");
      return u(), C("div", h, [
        e("div", $, [
          ...
          e("div", Q, [
            ...
            t[16] || (t[16] = n(" to toggle Command Palette "))
          ]),
          !o(_) && !o(D) ? (u(), C("div", W, [
            t[27] || (t[27] = n(" Press ")),
            o(M)() ? (u(), C(x, { key: 0 }, [
            ...
            t[28] || (t[28] = n(" to toggle DevTools "))
          ])) : H("", !0)
        ])
      ]);
    };
